...
latency_csv = "/scratch/zgh23/ThunderKittens/kernels/test_05_05_13_28/plot_results/merge_warp_latency.csv"
output_csv = "/scratch/zgh23/ThunderKittens/kernels/test_05_05_13_28/plot_results/summary_memory.csv"
def merge_spill_stall(latency_csv, output_csv):
    records = []
    latency_df = pd.read_csv(latency_csv)
    for i in range(len(latency_df)):
        shape = latency_df["shape"][i]
